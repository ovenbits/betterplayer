...
abstract class VideoPlayerPlatform {
  ...
  ///Update PiP support.
  Future<void> setPictureInPictureSupported(int? textureId, bool supported) {
    throw UnimplementedError('setPictureInPictureSupported() has not been implemented.');
  }
...
class DataSource {
  ...
  String toString() {
    return 'DataSource{sourceType: $sourceType, uri: $uri certificateUrl: $certificateUrl, formatHint:'
        ...
        '$maxCacheFileSize, showNotification: $showNotification, id: $id, album: $album, title: $title,'
        ' author: $artist, genre: $genre, duration: $duration}';
  }
}
