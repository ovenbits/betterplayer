...
class BetterPlayerDashUtils {
  ...
  static BetterPlayerAsmsAudioTrack parseAudio(XmlElement node, int index) {
    ...
    return BetterPlayerAsmsAudioTrack(id: index, segmentAlignment: segmentAlignmentStr.toLowerCase() == 'true', label: label, language: language, mimeType: mimeType);
  }
  ...
  static BetterPlayerAsmsSubtitle parseSubtitle(String masterPlaylistUrl, XmlElement node) {
    ...
    if (url?.contains("http") == false) {
      ...
      url = Uri(scheme: masterPlaylistUri.scheme, host: masterPlaylistUri.host, port: masterPlaylistUri.port, pathSegments: pathSegments).toString();
    }
    ...
    return BetterPlayerAsmsSubtitle(name: name, language: language, mimeType: mimeType, segmentAlignment: segmentAlignmentStr.toLowerCase() == 'true', url: url, realUrls: [url ?? '']);
  }
}
